...
public class CyActivator extends AbstractCyActivator {
	...
	// Type of graph displayed, generated by the statistics of this program.
	// Currently there are four types, default (null), best, best&unique and unique
	public static final String[] graphTypes = {null, "best", "best&unique", "unique"};
	// Default histogram to be displayed.
